...
import org.appspot.apprtc.perceive.MobileInsightReceiver;
...
public class ConnectActivity extends Activity {
    ...
    public static final int CONNECT_FBCC = 2;
    public static final int CONNECT_PERCEIVE = 3;

    private ImageButton addFavoriteButton;
    private EditText roomEditText;
    private EditText exIdEditText;
    ...
    private Button mStartLocalDefault;
    private Button mStartLocalFBCC;
    private Button mStartLocalPerceive;
    private Button mStartRemote;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        exIdEditText = (EditText) findViewById(R.id.edit_ex_id);
        ...
        mStartLocalDefault = (Button) findViewById(R.id.btn_start_local_default);
        mStartLocalFBCC = (Button)findViewById(R.id.btn_start_local_fbcc);
        mStartLocalPerceive = (Button)findViewById(R.id.btn_start_local_perceive);
        mStartRemote = (Button)findViewById(R.id.btn_start_remote);
        mStartLocalDefault.setOnClickListener(onButtonsClick);
        mStartLocalFBCC.setOnClickListener(onButtonsClick);
        mStartLocalPerceive.setOnClickListener(onButtonsClick);
        mStartRemote.setOnClickListener(onButtonsClick);
        ...
        if ("android.intent.action.VIEW".equals(intent.getAction()) && !commandLineRun) {
            ...
            connectToRoom(room, true, loopback, useValuesFromIntent, runTimeMs, false, CONNECT_DEFAULT);
        }
    }
    ...
    OnClickListener onButtonsClick = new OnClickListener() {
            ...
            public void onClick(View v) {
                StatusDataCollector.ex_id = exIdEditText.getText().toString();
                switch(v.getId()) {
                case R.id.btn_start_local_default:
                    connectToRoom(roomEditText.getText().toString(),
                                  false, false, false, 0, false, CONNECT_DEFAULT);
                    break;
                case R.id.btn_start_local_perceive:
                    connectToRoom(roomEditText.getText().toString(),
                                  false, false, false, 0, false, CONNECT_PERCEIVE);
                    break;
                case R.id.btn_start_local_fbcc:
                    connectToRoom(roomEditText.getText().toString(),
                                  false, false, false, 0, false, CONNECT_FBCC);
                    break;
                case R.id.btn_start_remote:
                    connectToRoom(roomEditText.getText().toString(),
                                  false, false, false, 0, true, CONNECT_DEFAULT);
                    break;
                }
            }
        };
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.action_settings) {
            ...
            connectToRoom(null, false, true, false, 0, false, CONNECT_DEFAULT);
            return true;
        } else {
    ...
    private void connectToRoom(String roomId, boolean commandLineRun, boolean loopback,
                               boolean useValuesFromIntent, int runTimeMs, boolean remote, int connect_type) {
        ...
        if (validateUrl(roomUrl)) {
            ...
            intent.setData(uri);
            intent.putExtra(CallActivity.EXTRA_REMOTE, remote);
            intent.putExtra(CallActivity.EXTRA_CONNECT_TYPE, connect_type);
    ...
    private final AdapterView.OnItemClickListener roomListClickListener =
        new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                connectToRoom(roomId, false, false, false, 0, false, CONNECT_DEFAULT);
            }
        };
    ...
    private final OnClickListener connectListener = new OnClickListener() {
            @Override
            public void onClick(View view) {
                connectToRoom(roomEditText.getText().toString(), false, false, false, 0, false, CONNECT_DEFAULT);
            }
        };
