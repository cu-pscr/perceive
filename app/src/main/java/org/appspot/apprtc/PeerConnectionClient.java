...
public class PeerConnectionClient {
    ...
    @Nullable private VideoEncoderFactory.FrameCallback frameCallback;
    /**
    ...
    public static class PeerConnectionParameters {
        ...
        private boolean receivingOnly = false;
        ...
        public PeerConnectionParameters(boolean videoCallEnabled, boolean loopback, boolean tracing,
                                        ...
                                        boolean useLegacyAudioDevice, DataChannelParameters dataChannelParameters, boolean receivingOnly) {
    ...
    public PeerConnectionClient(Context appContext,
                                ...
                                VideoEncoderFactory.FrameCallback frameCallback) {
    ...
    private void createPeerConnectionInternal() {
        ...
        if (isVideoCallEnabled()) {
            VideoTrack localTrack = createVideoTrack(videoCapturer);
            localTrack.setEnabled(!peerConnectionParameters.receivingOnly);
            peerConnection.addTrack(localTrack, mediaStreamLabels);
    ...
    private class PCObserver implements PeerConnection.Observer {
        ...
        @Override
        public void onTrack(RtpTransceiver rt) {
    ...
    public boolean setBitrate(int bitrate) {
        return peerConnection.setBitrate(bitrate, bitrate, (int)(bitrate * 2.5));
    }
}
