...
public class YuvUploader {
    ...
    @Nullable public static ByteBuffer copyBuffer;
    @Nullable private static int[] yuvTextures;
    @Nullable public static ByteBuffer packedByteBuffer;
    /**
     ...
     */
    @Nullable
    public static int[] uploadYuvData(int width, int height, int[] strides, ByteBuffer[] planes) {
    ...
    @Nullable
    public static int[] uploadFromBuffer(VideoFrame.I420Buffer buffer) {
    ...
    @Nullable
    public static int[] getYuvTextures() {
        return yuvTextures;
    }
